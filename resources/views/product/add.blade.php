...
@endif
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" name="sizeDis" rows="3"></textarea>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="maintenance" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
