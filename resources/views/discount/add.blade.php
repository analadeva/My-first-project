...
@endif
        ...
        <div class="d-flex justify-content-between">
                    <p style="font-size:1.5rem;"><a href="{{route('product')}}" class="mr-3 text-dark"><i class="fas fa-arrow-left"></i></a><b>Попуст/промо код</b></p>
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="disc" aria-describedby="emailHelp">
        </div>
